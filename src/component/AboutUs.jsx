const AboutUs = () => {
  return (
    <div className="relative  h-[554px] lg:h-[738px] xl:h-[640px]  overflow-hidden bg-[#01204c]">
      ...
      <img
        src="./0006-removebg-preview.png"
        className="w-40 absolute top-4 animate-spin-slow2 opacity-30 z-10 -right-10 md:top-12 md:w-60 lg:w-80 lg:-right-20 xl:w-[400px]"
      />
      {/* <img
      ...
      <div className=" text-white text-start absolute top-14 left-4  md:w-3/6 md:left-[48%] md:top-20 lg:top-[16%] ">
        <h1 className="text-3xl lg:text-6xl text-white font-serif font-bold ml-6 mb-3 sb">
          About Us
        </h1>
