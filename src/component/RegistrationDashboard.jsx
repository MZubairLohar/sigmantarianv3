        ...
        <div className="flex items-center justify-center flex-col gap-4">
          ...
          <div>
            <div
              ...
              class="relative w-full md:w-60 inline-flex items-center justify-center p-4 px-6 py-1 md:py-3 overflow-hidden font-medium text-[#caa8f5] transition duration-300 ease-out border-2 border-[#2563EB] rounded-full shadow-md group"
            >
              <span class="absolute inset-0 flex items-center justify-center w-full h-full text-white duration-300 -translate-x-full bg-[#2563EB] group-hover:translate-x-0 ease">
                <svg
                  class="w-6 h-6"
                  fill="none"
                  stroke="currentColor"
