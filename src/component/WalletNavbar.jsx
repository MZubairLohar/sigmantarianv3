...
export default function WalletNavbar() {
  ...
  return (
    <Disclosure
      as="nav"
      className="border-b-[1px] border-[#888888] bg-[#01204c]  sm:px-5"
    >
      {({ open }) => (
        <>
            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex  items-center justify-center gap-3">
                ...
                <button
                  ...
                  className="bg-blue-900 hidden md:block border border-white px-4 py-[10px] text-gray-200 font-semibold md:text-lg rounded-lg"
                >
                  Your Dashhboard{" "}
                </button>{" "}
                <button
