...
const About = () => {
  return (
    <div className="bg-[#01204c] overflow-hidden">
      ...
      {/* Container */}
      <div className="relative min-h-screen flex flex-col justify-center items-center px-4 sm:px-6 md:px-12 lg:px-20 py-12">
        {/* Background Gradients */}
        <div className="absolute -left-20 -top-20 custom-radial-gradient3 opacity-60 w-full"></div>
        ...
        <img
          ...
          className="w-24 sm:w-32 md:w-60 lg:w-96 opacity-30 animate-spin-slow2 absolute top-10 right-2 sm:right-4"
        />
